    ...
    switch($data['id']) {
        ...
        case 'wdf_pledge_info' :
                ...
                <?php else : ?>
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <p><input type="text" name="wdf[transaction][name]" value="<?php echo isset($trans['first_name']) ? esc_attr($trans['first_name']) : ''; ?><?php echo isset($trans['last_name']) ? ' ' . esc_attr($trans['last_name']) : ''; ?>" /></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                            ...
                            <td>
                                <p><input type="text" name="wdf[transaction][payer_email]" value="<?php echo isset($trans['payer_email']) ? esc_attr($trans['payer_email']) : ''; ?>" /></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
            ...
            <?php else : ?>
                ...
                <p><?php echo esc_html($trans['first_name']) . ' ' . esc_html($trans['last_name']); ?> | <a href="mailto:<?php echo esc_attr($trans['payer_email']); ?>"><?php echo esc_html($trans['payer_email']); ?></a></p>

                <?php if(isset($trans['address1']) && !empty($trans['address1'])) :?>
                    <h4><?php _e('Address','wdf'); ?>:</h4>
                    <p>
                        <?php if(isset($trans['country']) && !empty($trans['country'])) : echo esc_html($trans['country']).' ('.__('Country','wdf').')</br>'; endif; ?>
                        <?php if(isset($trans['address1']) && !empty($trans['address1'])) : echo esc_html($trans['address1']).' ('.__('Address','wdf').')</br>'; endif; ?>
                        <?php if(isset($trans['address2']) && !empty($trans['address2'])) : echo esc_html($trans['address2']).' ('.__('Address 2','wdf').')</br>'; endif; ?>
                        <?php if(isset($trans['city']) && !empty($trans['city'])) : echo esc_html($trans['city']).' ('.__('City','wdf').')</br>'; endif; ?>
                        <?php if(isset($trans['state']) && !empty($trans['state'])) : echo esc_html($trans['state']).' ('.__('State','wdf').')</br>'; endif; ?>
                        <?php if(isset($trans['zip']) && !empty($trans['zip'])) : echo esc_html($trans['zip']).' ('.__('Postal/Zip Code','wdf').')</br>'; endif; ?>
                    </p>
                <?php endif; ?>
            ...
            <table class="widefat">
                ...
                <?php foreach($donations as $donation) : ?>
                    ...
                    <tr class="wdf_actvity_level">
                        ...
                        <td><?php echo esc_html($trans['status']); ?></td>
                        <td><label><?php echo esc_html($trans['first_name']).' '.esc_html($trans['last_name']); ?></label><br /><a href="mailto:<?php echo esc_attr($trans['payer_email']); ?>"><?php echo esc_html($trans['payer_email']); ?></a></td>
                        <td><?php echo esc_html($trans['gateway']); ?></td>
                        <td><?php echo get_post_modified_time('F d Y', null, $donation->ID) ?></td>
                        <td><a class="hidden" href="<?php echo get_edit_post_link($donation->ID); ?>">Pokaż</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
